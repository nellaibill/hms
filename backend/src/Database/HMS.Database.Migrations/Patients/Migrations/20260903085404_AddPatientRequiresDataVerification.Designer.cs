...
namespace HMS.Database.Migrations.Patients.Migrations
{
    ...
    [Migration("20260903085404_AddPatientRequiresDataVerification")]
    partial class AddPatientRequiresDataVerification
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HMS.Modules.Patients.Domain.Patient", b =>
                {
                    ...
                    b.Property<bool>("RequiresDataVerification")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                        .HasColumnName("requires_data_verification");
                    ...
                    b.HasIndex("RequiresDataVerification")
                        .HasDatabaseName("ix_patients_requires_data_verification")
                        .HasFilter("requires_data_verification = true");
