...
/// <summary>
/// Department master CRUD — the single source of truth for a hospital department, used by
/// both HR (WeeklyRoster/ShiftAssignment's DepartmentId) and Patients (a visit's Department).
/// Originally lived in HMS.Modules.HR; consolidated here (see docs/DecisionLog.md) so the two
/// modules can't drift into two independently-maintained department lists.
/// </summary>
[ApiController]
[Route("api/v1/masters/departments")]
