...
public class AuthenticationServiceTests
{
    ...
    public AuthenticationServiceTests()
    {
        _sut = new AuthenticationService(
            _userRepository, _roleRepository, _passwordHasher, _jwtTokenGenerator, NullLogger<AuthenticationService>.Instance);
    }
    ...
    private (User User, Role Role) SeedActiveUserWithMatchingRole(string loginType = "doctor", string roleName = "Doctor / Consultant")
    {
        ...
        _jwtTokenGenerator
            .GenerateToken(user.Id, user.Username, role.Id, role.Name, loginType)
