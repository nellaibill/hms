...
public class IdentityModuleBoundaryTests
{
    ...
    /// - IUserService: UsersController — which ASP.NET Core requires to be a public class
    ///   with a public constructor for controller discovery/DI activation — takes it as a
    ///   constructor dependency; a public constructor cannot have an internal parameter type
    ///   (CS0051). This is the module's one deliberate seam between its public HTTP boundary
    ///   and its internal Application/Domain/Infrastructure layers.
