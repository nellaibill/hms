...
export { HospitalConfigurationDialog } from './components/HospitalConfigurationDialog';
...
export { useHospitalConfigurationQuery } from './hooks/useHospitalConfigurationQuery';
export { useUpdateHospitalConfigurationMutation } from './hooks/useUpdateHospitalConfigurationMutation';
