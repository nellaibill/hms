  ...
  return (
    <div className="flex flex-1 flex-col">
      <div className="px-6 pt-4 lg:px-8">
        <Link to={`/admin/hr/weekly-rosters/${id}`} className="inline-flex items-center gap-1 text-sm text-muted-foreground hover:text-foreground">
      ...
      <div className="mt-3 flex flex-col items-center gap-1 bg-page-banner px-6 py-5 text-center text-page-banner-foreground">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-xl font-semibold tracking-tight">Edit Weekly Roster</h1>
        </div>
        <p className="text-sm text-page-banner-foreground/85">Update this roster's week and department.</p>
      </div>
